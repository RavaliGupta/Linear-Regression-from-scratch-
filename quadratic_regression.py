...
def run():
    ...
    learning_rate = 0.1
    initial_thetha0 = 0.1
    initial_thetha1 = 0.01
    initial_thetha2 = 0.001
    num_iterations = 5000
    plt.scatter(x, y)
    ...
    print ("Running...")
    [thetha0, thetha1, thetha2] = gradient_descent_runner(x,y, initial_thetha0, initial_thetha1, initial_thetha2, learning_rate, num_iterations)
    ...
    plt.plot(x, thetha2*feature_x*feature_x+thetha1*feature_x+thetha0, color='r')
    plt.show()
